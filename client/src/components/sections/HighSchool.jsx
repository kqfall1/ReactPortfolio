            ...
            <div className="horizontalSectionSidebar">
                <div className="highSchoolDescription">
                    <p>
                        ...
                        in Grade 12 (CCENT, which was retired the same year I passed it). I am also glad that I 
                        learned the fundamentals of programming there, because they have stuck with me ever since! 
                        We had to use Java to bubble sort arrays without using any built-in sorting methods once. 
                        It was challenging, but it taught me lots about recursion! I didn't realize how good the 
                        curriculum was at R.H. King until I started college. I wish I took my studies more seriously
                        while I was there.    
                    </p>
                </div>
